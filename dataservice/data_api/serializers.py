...
class UserSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        user_profile = UserProfile.objects.filter(id=instance.id)
...
class ShowUserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        read_only_fields = ("created_user", "updated_user", "created_at", "updated_at")
...
class StudentCourseStructureSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        read_only_fields = ("updated_user", "created_at", "updated_at")
...
class CommitteeUserSerializer(serializers.ModelSerializer):
    name_committee1 = UserDetailsSerializerNoFile()
    name_committee2 = UserDetailsSerializerNoFile()
    name_committee3 = UserDetailsSerializerNoFile()
    name_committee4 = UserDetailsSerializerNoFile()
    name_committee5 = UserDetailsSerializerNoFile()
    name_committee6 = UserDetailsSerializerNoFile()
...
class TransferringEquivalentCourseSerializer(serializers.ModelSerializer):
    ...
    name_committee5 = UserDetailsSerializerNoFile()
    name_committee6 = UserDetailsSerializerNoFile()
    advisor = UserDetailsSerializerNoFile()
    head_department = UserDetailsSerializerNoFile()
    head_educational = UserDetailsSerializerNoFile()
    deputy_dean_a_r = UserDetailsSerializerNoFile()
    dean = UserDetailsSerializerNoFile()
    head_academic_p_r = UserDetailsSerializerNoFile()
    registrar_officer = UserDetailsSerializerNoFile()
...
class TransferringEquivalentCourseCreateSerializer(serializers.ModelSerializer):
    equivalent_item = EquivalentCourseCreateSerializer(required=False, many=True)
...
class TransferringEquivalentCourseUpdateSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        if validated_data.get("number_of_equivalent"):
            instance.number_of_equivalent = validated_data.get("number_of_equivalent")
        ...
        if validated_data.get("is_approve_committee1"):
            instance.is_approve_committee1 = validated_data.get("is_approve_committee1")
        if validated_data.get("is_approve_committee2"):
            instance.is_approve_committee2 = validated_data.get("is_approve_committee2")
        if validated_data.get("is_approve_committee3"):
            instance.is_approve_committee3 = validated_data.get("is_approve_committee3")
        if validated_data.get("is_approve_committee4"):
            instance.is_approve_committee4 = validated_data.get("is_approve_committee4")
        if validated_data.get("is_approve_committee5"):
            instance.is_approve_committee5 = validated_data.get("is_approve_committee5")
        if validated_data.get("is_approve_committee6"):
            instance.is_approve_committee6 = validated_data.get("is_approve_committee6")
        ...
        if validated_data.get("head_department_date"):
            instance.head_department_date = validated_data.get("head_department_date")
        ...
        if validated_data.get("head_educational_date"):
            instance.head_educational_date = validated_data.get("head_educational_date")
        ...
        if validated_data.get("deputy_dean_a_r_date"):
            instance.deputy_dean_a_r_date = validated_data.get("deputy_dean_a_r_date")
        ...
        if validated_data.get("head_academic_p_r"):
            instance.head_academic_p_r = validated_data.get("head_academic_p_r")
        ...
        if validated_data.get("registrar_officer"):
            instance.registrar_officer = validated_data.get("registrar_officer")
        ...
        if validated_data.get("is_retry"):
            instance.is_retry = validated_data.get("is_retry")
        if validated_data.get("is_change_subject"):
            instance.is_change_subject = validated_data.get("is_change_subject")
        if validated_data.get("is_change_school"):
            instance.is_change_school = validated_data.get("is_change_school")
        if validated_data.get("is_studied"):
            instance.is_studied = validated_data.get("is_studied")
