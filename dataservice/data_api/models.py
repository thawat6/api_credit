...
class UserProfile(models.Model):
    ...
    level_studied = models.CharField(
        max_length=250,
        null=True,
        blank=True,
    )
    ...
    def save(self, *args, **kwargs):
        ...
        if self.title:
            self.full_name = self.title + " " + self.full_name
...
class EquivalentCourse(models.Model):
    status = models.CharField(max_length=100, default="รอตรวจสอบ")
    credit1 = models.CharField(
        max_length=25,
        null=True,
        blank=True,
    )
    credit2 = models.CharField(
        max_length=25,
        null=True,
        blank=True,
    )
    credit3 = models.CharField(
        max_length=25,
        null=True,
        blank=True,
    )
    credit4 = models.CharField(
        max_length=25,
        null=True,
        blank=True,
    )
    credit5 = models.CharField(
        max_length=25,
        null=True,
        blank=True,
    )
    credit6 = models.CharField(
        max_length=25,
        null=True,
        blank=True,
    )
    ...
    student_course1 = models.ForeignKey(
    ...
    student_course2 = models.ForeignKey(
        StudentCourseStructure,
    ...
    student_course3 = models.ForeignKey(
        StudentCourseStructure,
    ...
    student_course4 = models.ForeignKey(
        StudentCourseStructure,
    ...
    student_course5 = models.ForeignKey(
        StudentCourseStructure,
    ...
    student_course6 = models.ForeignKey(
        StudentCourseStructure,
    ...
    course_enroll = models.ForeignKey(
        StructurePreferredCourseEnroll, null=True, blank=True, on_delete=models.SET_NULL
    )
...
class CommitteeUser(models.Model):
    name_committee1 = models.ForeignKey(
        User,
        null=True,
        blank=True,
    ...
    name_committee2 = models.ForeignKey(
        User,
        null=True,
        blank=True,
    ...
    name_committee3 = models.ForeignKey(
        User,
        null=True,
        blank=True,
    ...
    name_committee4 = models.ForeignKey(
        User,
        null=True,
        blank=True,
    ...
    name_committee5 = models.ForeignKey(
        User,
        null=True,
        blank=True,
    ...
    name_committee6 = models.ForeignKey(
        User,
        null=True,
        blank=True,
...
class TransferringEquivalentCourse(models.Model):
    ...
    equivalent_item = models.ManyToManyField(
        EquivalentCourse, blank=True, related_name="transferring_equivalent_item"
    )
    # เคยศึกษาจาก
    studied_from = models.CharField(
        max_length=250,
        null=True,
        blank=True,
    )
    ...
    advisor_date = models.DateTimeField(
        null=True,
        blank=True,
    )
    ...
    head_department_date = models.DateTimeField(
        null=True,
        blank=True,
    )

    # หัวหน้างานบริการการศึกษา สำนักงานคณบดี
    head_educational = models.ForeignKey(
        User,
        null=True,
        blank=True,
    ...
    head_educational_date = models.DateTimeField(
        null=True,
        blank=True,
    )

    # รองคณบดีฝ่ายวิชาการและวิจัย
    deputy_dean_a_r = models.ForeignKey(
        User,
        null=True,
        blank=True,
    ...
    deputy_dean_a_r_date = models.DateTimeField(
        null=True,
        blank=True,
    )
    ...
    dean = models.ForeignKey(
        User, null=True, blank=True, related_name="dean_user", on_delete=models.SET_NULL
    )
    ...
    dean_date = models.DateTimeField(
        null=True,
        blank=True,
    )

    # หัวหน้าแผนกงานส่งเสริมวิาการและงานทะเบียน
    head_academic_p_r = models.ForeignKey(
        User,
        null=True,
        blank=True,
    ...
    head_academic_p_r_date = models.DateTimeField(
        null=True,
        blank=True,
    )

    # เจ้าหน้าที่ทะเบียน
    registrar_officer = models.ForeignKey(
        User,
        null=True,
        blank=True,
    ...
    registrar_officer_date = models.DateTimeField(
        null=True,
        blank=True,
    )
